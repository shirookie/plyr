...
const controls = {
    ...
    createButton(buttonType, attr) {
        const attributes = Object.assign({}, attr); // {}
        let type = toCamelCase(buttonType); // 'play'

        // done
        const props = {
            element: 'button',
            toggle: false, // except this one
            label: null,
            icon: null,
            labelPressed: null,
            iconPressed: null,
        ...
        switch (buttonType) {
            ...
            default:
                if (is.empty(props.label)) {
                    props.label = type; // done => 'button'
                }
                if (is.empty(props.icon)) {
                    props.icon = buttonType; // done
                }
        }

        const button = createElement(props.element); // 'button'
